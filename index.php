        ...
        var map = new ol.Map({
            layers: [Basemap, new ol.layer.Tile({
                ...
                new ol.layer.Tile({
                    ...
                    name: 'Jalan Provinsi Prov. Kalimantan Selatan',
                    LegenUrl: '',
                    LegentType: 'ESRI',
                    InfoPopup: false,
                    metadata: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_JALAN_PROVINSI/MapServer/info/iteminfo',
                    visible: true
                }),
                new ol.layer.Tile({
                    source: new ol.source.TileArcGISRest({
                    ...
                    name: 'Kebakaran Hutan Lahan Prov. Kalimantan Selatan',
                    LegenUrl: '',
                    LegentType: 'ESRI',
                    InfoPopup: false,
                    metadata: 'https://geoportal.kalselprov.go.id/arcgis/rest/services/Kalsel/KALSEL_KARHUTLA_2021_PT_1OK/MapServer/info/iteminfo',
                    visible: true
                })
            ],
            target: 'map',
